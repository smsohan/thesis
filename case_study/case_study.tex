...
\chapter{\texorpdfstring{A Case Study of Web API Evolution \protect\footnote{S. Sohan, C. Anslow, and F. Maurer, ``A case study of Web API evolution,'' in Proc. of IEEE World Congress on Services (SERVICES). IEEE, 2015, pp. 245-252.}}{S. Sohan, C. Anslow, and F. Maurer, ``A case study of Web API evolution,'' in Proc. of IEEE World Congress on Services (SERVICES). IEEE, 2015, pp. 245–252.}}
  ...
  \begin{subfigure}[b]{\textwidth}
    ...
    \begin{tikzpicture}[show background rectangle,tight background]
      \begin{axis}[
        ...
        \input{case_study/change_frequency}
      \end{axis}
    \end{tikzpicture}
