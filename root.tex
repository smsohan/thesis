...
% 1, the ‘fancy’ package is cancelled. The pagestyle is changed from ‘myheadings’ and ‘headings’ to ‘plain’ to move the page number (footer) from top right to bottom centre.
% 2, The parameter  of using ‘geometry’ package is changed from four different values (top=1in, bottom=1.22in, left=1.40in, right=0.850in) to one single value: 1in (top=1in, bottom= 1in, left= 1in, right= 1in)
% 3, ‘List of Figures’ is modified to ‘List of Figures and Illustrations’
% 4, A new page ‘List of Symbols, Abbreviations and Nomenclature’ is created. Its page number is following ‘List of Figures and Illustrations’ with Roman numerals. A separate file ‘symbols.tex’ is created for students to put content into the list.
...
\pgfplotsset{table/search path={controlled_study}}
