\chapter{\texorpdfstring{A Study of the Effectiveness of Usage Examples in REST API Documentation \protect\footnote{S. Sohan, C. Anslow, F. Maurer, and M. Robillard, ``A study of the effectiveness of usage examples in REST API documentation,'' in to appear in Proc. of IEEE Symposium on Visual Languages and Human-Centric Computing, 2017.}}{A Study of the Effectiveness of Usage Examples in REST API Documentation}}
...
To answer the aforementioned research question, the study has the following requirements (Ethics Certificate in Appendix~\ref{ethics}):
