...
\begin{table}
  ...
  \hline
  Chapter~\ref{chapter:spy_rest} & RG1 and RG2 & RO3 and RO3 & SpyREST: Automated RESTful API documentation using an HTTP proxy server \cite{sohan2015spyrest}. & A list of requirements and the concept of using interception to generate REST API documentation to satisfy the requirements. \\
  \hline
