...
\begin{itemize}
  \item What impact does usage examples have on REST API client developer productivity?
  \item What what problems API client developers face when using a REST API where documentation lacks usage examples?
\end{itemize}
